...
class CustomTextFieldStockQuantity extends StatelessWidget {
  const CustomTextFieldStockQuantity(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: const TextStyle(
          fontWeight: FontWeight.w600, fontSize: 20, color: primaryTextColor),
